...
export default function Portofolio() {
  ...
  return (
    ...
    <section className='flex align-middle justify-center mt-52 h-96'>
        {/* <div className='border-white absolute mt-20 w-25  '>
            <h1 className=' -mt-44 font-bold text-xl dark:text-white mb-10'>This is my Github</h1>
            <p className=' -mt-32 font-bold text-xl dark:text-white'>Click Repo for views</p>
        </div>
        <form id="form">
